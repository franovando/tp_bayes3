...
```{r}
#| label: fig-1
#| fig-cap: "Altura de la pelota en el planeta X durante el experimento" 
...
La @fig-10 muestra la distribución predictiva *a posteriori* de la posición de la pelota a través del tiempo, según el modelo 2 ajustado. En este se visualiza la media de las predicciones (en azul), acompañada por las bandas de credibilidad del 95% para la distribución condicional de $\mu$ (en gris oscuro), y para las observaciones futuras (en gris claro).
